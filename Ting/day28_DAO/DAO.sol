...
contract DecentralizedGovernance is ReentrancyGuard{
    ...
    event QuorumNoteMet(uint256 indexed proposalId);
    ...
    constructor(
        address _governanceToken, // 治理币的合约地址
    ...
    // 管理员设置参数
    function setQuorumPercantage(uint256 _newQuorum) external onlyAdmin{
